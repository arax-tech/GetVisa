                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <a  class="btn btn-danger Delete" href="{{ url('admin/application/delete/'.$application->id) }}" onclick="return confirm('are you sure to delete ?');">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="{{ url('admin/application/update/'.$application->id) }}">
                                                        @csrf
                                                        <div class="row mb-3">
                                                        ...
                                                        <div class="row mb-3">
                                                                ...
                                                                <select class="form-control" name="visa_type" required>
                                                                    ...
                                                                    @foreach ($categories as $category)
                                                                        <option value="<?php echo $category->name."-|-".$category->price?>"
                                                                            @if ($application->visa_type == $category->name)
                                                                                selected
                                                                            @endif
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input type="text" class="form-control" id="price" value="{{ $application->price }}">
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <select class="form-control" name="status" required>
                                                                    <option selected disabled value="">Choose</option>
                                                                    <option value="Awaiting for Documents"
                                                                    @if ($application->status == "Awaiting for Documents")
                                                                        selected 
                                                                    @endif
                                                                    >Awaiting for Documents</option>
                                                                    <option value="Documents Received"
                                                                    @if ($application->status == "Documents Received")
                                                                        selected 
                                                                    @endif
                                                                    >Documents Received</option>
                                                                    <option value="Incomlete Documents"
                                                                    @if ($application->status == "Incomlete Documents")
                                                                        selected 
                                                                    @endif
                                                                    >Incomlete Documents</option>
                                                                    <option value="Pending"
                                                                    @if ($application->status == "Pending")
                                                                        selected 
                                                                    @endif
                                                                    >Pending</option>
                                                                    <option value="Submission Done"
                                                                    @if ($application->status == "Submission Done")
                                                                        selected 
                                                                    @endif
                                                                    >Submission Done</option>
                                                                    <option value="Visa In Progress"
                                                                    @if ($application->status == "Visa In Progress")
                                                                        selected 
                                                                    @endif
                                                                    >Visa In Progress</option>
                                                                    <option value="Additional Docuemnts Req."
                                                                    @if ($application->status == "Additional Docuemnts Req.")
                                                                        selected 
                                                                    @endif
                                                                    >Additional Docuemnts Req.</option>
                                                                    <option value="Application Under Review"
                                                                    @if ($application->status == "Application Under Review")
                                                                        selected 
                                                                    @endif
                                                                    >Application Under Review</option>
                                                                    <option value="Visa Rejected"
                                                                    @if ($application->status == "Visa Rejected")
                                                                        selected 
                                                                    @endif
                                                                    ...
                                                                    <option value="Documents Dispatched"
                                                                    @if ($application->status == "Documents Dispatched")
                                                                        selected 
                                                                    @endif
                                                                    >Documents Dispatched</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input type="text" class="form-control" name="remarks" required value="{{ $application->remarks }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
